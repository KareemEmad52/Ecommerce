...
export default function CartContextProvider(props){
    ...
    return <cartContext.Provider value={{addToCart ,deleteCart ,cartProductNum ,setcartProductNum , cartId , onlinePayment , getUserCart , removeCartItem , updateCountProduct}}>
        {props.children}
